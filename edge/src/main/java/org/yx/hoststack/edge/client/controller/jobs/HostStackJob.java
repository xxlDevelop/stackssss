...
public abstract class HostStackJob {
    ...
    protected <T> CommonMessage<T> buildJobMessage(String jobId, String hostId, String jobMethod, String traceId, T data) {
        return CommonMessage.<T>builder()
    ...
    protected void sendJobToAgent(Session agentSession, C2EMessage.C2E_DoJobReq centerJobReq, CommonMessage<?> agentJobMessage,
